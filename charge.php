...
$netapaye = mysqli_real_escape_string($conn, $_POST['netapaye']);
$prestateurvendeur = mysqli_real_escape_string($conn, $_POST['prestateurvendeur']);

$sql = "INSERT INTO charges(namee,typee,datee,descrip,netapaye,prestateurvendeur) VALUES('$name','$typee','$datee','$descrip','$netapaye','$prestateurvendeur')";
                ...
                <div id="AjouteForm" class="forms absolute top-6 md:top-1/2 left-1/2 -translate-x-1/2 md:-translate-y-1/2 w-h90 h-b90">
                    <div class="flex justify-between w-full h-16 md:h-20">
                        <div class="w-full md:w-1/2 h-full">
                            <h4 class="font-sifonn text-2xl md:text-3xl text-slate-900">Ajouter une charge</h4>
                    ...
                    <div class="w-full">
                        <div class="relative w-full h-52 md:h-80 overflow-hidden rounded bg-center bg-cover bg-[url('https://images.unsplash.com/photo-1554224155-3a58922a22c3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1141&q=80')]">
                            <div class="bg-gr"></div>
                        ...
                        <form action="" method="post">
                            <div class="grid grid-cols-2 gap-x-4 gap-y-4">
                                <div class="h-max col-span-2 md:col-span-1">
                                    <h4 class="font-sifonn text-xl mb-1 text-slate-900">Type de charge :</h4>
                                    <select name="typee" id="" class="w-full bg-white border border-gray-300 outline-blue-400 rounded px-3 py-3">
                                            <option>Charge de empanne</option>
                                            <option>Charge d'energy</option>
                                            <option>Invesstissement</option>
                                    </select>
                                </div>
                                <div class="h-max col-span-2 md:col-span-1">
                                    <h4 class="font-sifonn text-xl mb-1 text-slate-900">Description de Charge :</h4>
                                    <input name="descrip" type="text" placeholder="Par defaut : accune description" class="w-full placeholder-gray-500 bg-white border border-gray-300 outline-blue-400 rounded px-3 py-3">
                                </div>
                                <div class="h-max col-span-2 md:col-span-1">
                                    <h4 class="font-sifonn text-xl mb-1 text-slate-900">Net a paye :</h4>
                                    <input name="netapaye" type="text" placeholder="Net a paye en DH" class="w-full placeholder-gray-500 bg-white border border-gray-300 outline-blue-400 rounded px-3 py-3">
                                </div>
                                <div class="h-max col-span-2 md:col-span-1">
                                    <h4 class="font-sifonn text-xl mb-1 text-slate-900">Prestateur/Vendeur de produit :</h4>
                                    <select name="prestateurvendeur" id="" class="w-full bg-white border border-gray-300 outline-blue-400 rounded px-3 py-3">
                                            <option>Afriquia</option>
                                            <option>Total</option>
                                            <option>cycliss sa9aya</option>
                                    </select>
                                </div>
